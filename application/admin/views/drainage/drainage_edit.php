            ...
            <div class="box-header">
              <h3 class="box-title">
                ...
                <span style=" float: left; margin-top: 10px;" >
                  <button><a href="<?php echo site_url('/Drainage/drainage_add')?>"> <font color="black">添加引流</font></a></button>
                  ...
                  ?>
                	...
                	<tr>
                		...
                		<td><?php echo $value['name'];?></td>
                	     ...
                	     <td><a href="<?php echo site_url('/Drainage/drainage_update?weight='.$value['weight'])?>"> 编辑</a>/<a href="<?php echo site_url('/Drainage/drainage_edit?weight='.$value['weight'])?>">删除</a></td>
