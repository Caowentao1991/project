...
<div class="content_wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <aside>
                    <header><i class="fa fa-fw fa-file"></i>平台列表</header>
                    <section>
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="btn-group" style="margin-bottom:20px;">
                                        <a class="btn btn-default J_ajax_content_modal" data-href="<?=site_url('product/addPlatform?type=add');?>"><i class="fa fa-file-o"></i>添加新平台</a>
                                    </div>
