...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url();?>static/Main/css/mine_change_indent.css"> </head>

<body>
<div class="container">
    <header id="header">设置身份</header>
    <div class="mine_indent_main">
        <p>请选择身份</p>
        ...
        <h6><i>*</i>请务必保证信息真实，以便为您推荐最精准产品</h6>
        <h6><i>*</i>若身份发生变更，请到“我的—账户信息”进行身份更改</h6>
        <span class="sureBtn">确认</span>
    </div>
</div>
<script src="<?=base_url();?>static/Main/js/jquery.min.js"></script>
<script src="<?=base_url();?>static/Main/js/backDefault.js"></script>
<script src="<?=base_url();?>static/Main/js/controler/global.js"></script>
<script src="<?=base_url();?>static/Main/js/controler/mine_change_indent.js"></script>
<!--<script src="--><?//=base_url();?><!--static/Main/js/js/statistics.js"></script>-->
</body>
