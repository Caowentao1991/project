...
<div class="container">
    <!--头部-->
    <header><span onclick="javasceipt:history.back(-1);" id="hack"> </span>修改密码 </header>
    <!--主体-->
    <section>
        <div class="yfs">
            <p>修改密码前请先完成认证<br><span class="textStatus">点击获取验证码，发送短信到</span></p>
            <p>+86 <b></b></p>
        </div>
        <div class="input_ma">
...
<script src="<?=base_url();?>static/Main/js/controler/mine_changemima2.js"></script>
