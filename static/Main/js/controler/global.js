...
var localFun = {
    ...
    //     var cover = '<div class="downloadCover">' + '<img src="../static/Main/img/downloadBg.png" alt="" class="download">' + '<img src="../static/Main/img/coverBtn.png" alt="" class="coverBtn">' + '</div>';
...
$.extend({
    ...
    popupCover: function (opts) {
        ...
        $('.hintPopup').css({
            ...
            "text-align": "left",
            "background": "#000 url('/static/Main/img/sudaige.png') no-repeat .2rem center",
...
document.write('<script src="/static/Main/js/service/address.js"></script>');
document.write('<script src="/static/Main/js/service/service.js"></script>');
