var indexController = {
    ...
    initBaseView: function () {
        ...
        if (sd_wechat_login) {
            var url = sd_wechat_login.replace(/\*/g, '=');
            var base = new $.Base64();
    ...
    initPromotionQuestionView: function () {
        $('#recommend_Btn').on('click', function () {
            $.promptCover({
                ...
                content: "据您个人信息为您精准推荐最适合产品，请务必保证信息真实完整，以提高推荐精度。"
            });
        });
    ...
    doNextbatchView: function (list) {
        ...
        $("#recommend_list").on('click', 'dl', function () {
            ...
            window.location.href = "/mobile/index.php/product/result?productId=" + productId
        });
    },
    //新品入住
