var mineController = {
        ...
        if (localStorage.userId) {
            service.doAjaxRequest({
                ...
                if (b.user_photo != '') {
                    ...
                    $('#show_img').css({
                        "background-image": "url(/static/Main/img/sudaidai.png)",
    ...
    doMenuJumpView: function () {
        ...
        $.LogonStatusEvent($("#mine"), function () {
            window.location.href = "/mobile/index.php/mine_account_information";
        });
        //积分跳转
        ...
        $(".mmbl_shezhi").click(function () {
            window.location.href = "/mobile/index.php/mine/mine_personal_setup"
        });
        /*签到*/
