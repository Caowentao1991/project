    ...
    doProductsListView: function () {
        ...
        service.doAjaxRequest({
            ...
            $.each(json.list, function (i, b) {
                ...
                html += "</p>" + "<em class='rightIcon'>" + "</em>" + "</dd>" + "</dl>" + "<div class='res_btm'>" + "<div><b>" + b.product_introduct + "</b><span><img src='/static/Main/img/list_time_icon.png'>" + b.fast_time + "</span></div> </div>" + "</div>";
            });
