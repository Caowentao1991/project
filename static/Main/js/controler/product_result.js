var productResultController = {
    ...
    doProductDetailView: function (obj) {
        ...
        $.each($(".bgShow"), function () {
            ...
            switch (bgCenter) {
                case '凑合':
                    $(this).css({
                        "background": "url('/static/Main/img/couhuo@2x.png') no-repeat",
                        "background-size": '.3rem 100%'
                    });
                    break;
                case '普通':
                    $(this).css({
                        "background": "url('/static/Main/img/putong@2x.png') no-repeat",
                        "background-size": '.6rem 100%'
                    });
                    break;
                case '较好':
                    $(this).css({
                        "background": "url('/static/Main/img/jiaohao@2x.png') no-repeat",
                        "background-size": '.9rem 100%'
                    });
                    break;
                case '良好':
                    $(this).css({
                        "background": "url('/static/Main/img/lianghao@2x.png') no-repeat",
                        "background-size": '1.2rem 100%'
                    });
                    break;
                case '优秀':
                    $(this).css({
                        "background": "url('/static/Main/img/youxiu@2x.png') no-repeat",
                        "background-size": '1.5rem 100%'
                    });
                    break;
                case '爆款!':
                    $(this).css({
                        "background": "url('/static/Main/img/baokuan@2x.png') no-repeat",
    ...
    doWxView: function () {
        ...
        $.ajax({
            type: "post",
            url: api_sudaizhijia_host + "/wechat",
            dataType: "json",
            data: {
                url: url
            },
