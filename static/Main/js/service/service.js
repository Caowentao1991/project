...
var address = {
    FAVOURITE_NEWSCOLLECTION: api_sudaizhijia_host + '/favourite/newscollection', //活动咨询-关注
    FAVOURITE_COLLECTION: api_sudaizhijia_host + '/favourite/collection', //产品详情-关注
    COMMENT_USEFUL: api_sudaizhijia_host + '/comment/useful', //产品详情&更多评论-楼主有用
    COMMENT_USEFUL_REPLY: api_sudaizhijia_host + '/reply/useful', //更多评论-回复有用
    CLUB_BIND: api_sudaizhijia_host + '/club/bind', //论坛
    SHOP: api_sudaizhijia_host + '/credit/shop', //论坛
    WECHAT_SHARE: api_sudaizhijia_host + '/wechat', //微信分享
    GEETES_CAPTCHA: api_sudaizhijia_host + '/geetes/captcha' //极验一次验证
};
